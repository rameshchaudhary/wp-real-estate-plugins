    ...
    class Attachments
    {
        ...
        function meta_box_init()
        {
            ...
            if( !empty( $this->instances_for_post_type ) )
            {
                foreach( $this->instances_for_post_type as $instance )
                {
                    ...
                    $priority           = isset($instance->priority) ? $instance->priority : 'low';
        ...
        function register( $name = 'attachments', $params = array() )
        {
            $defaults = array(
                    ...
                    'label'         => __( 'Add Property Images', 'attachments' ),

                    // all post types to utilize (string|array)
                    'post_type'     => array( 'ob_property'),
                    ...
                    // text for 'Add Property Images' button (string)
                    'button_text'   => __( 'Add Property Images', 'attachments' ),

                    // text for modal 'Add Property Images' button (string)
                    'modal_text'    => __( 'Add to Property Images', 'attachments' ),
